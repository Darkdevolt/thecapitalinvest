...
(function(){
  ...
  function injectCss(){
    ...
    s.textContent=`
      ...
      .header .nav-dropdown-menu{display:none!important;visibility:hidden!important;opacity:0!important;pointer-events:none!important;position:absolute!important;top:calc(100% + 8px)!important;left:0!important;z-index:7000!important;min-width:230px!important;max-width:min(360px,calc(100vw - 24px))!important;max-height:calc(100vh - 92px)!important;overflow-y:auto!important;overflow-x:hidden!important;transform:translateY(-4px)!important;transition:opacity .14s ease,transform .14s ease,visibility .14s ease!important}
      .header .nav-dropdown.open > .nav-dropdown-menu{display:block!important;visibility:visible!important;opacity:1!important;pointer-events:auto!important;transform:none!important}
      ...
      @media(max-width:900px){
        ...
        .header .nav-dropdown-menu{position:fixed!important;top:58px!important;left:auto!important;max-height:calc(100vh - 70px)!important}
      }
      @media(max-width:480px){.header .nav-dropdown-menu{top:54px!important;max-height:calc(100vh - 64px)!important}}
    `;
