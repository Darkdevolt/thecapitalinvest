...
const TITLES = {
  ...
  'analyse-detail':'Detail Analyse',
  'analyse-technique':'Analyse Technique',
  screener:'Screener BRVM',
  portefeuille:'Portefeuille',
  alertes:'Alertes de Prix',
  financials:'Etats Financiers',
  'financials-detail':'Detail Financier',
  fiche:'Fiche Titre',
...
const BREADCRUMBS = {
  ...
  'analyse-detail': [{label:'Tableau de bord', view:'overview'}, {label:'Analyses', view:'analyses'}, {label:'Detail', view:'analyse-detail'}],
  ...
  financials: [{label:'Tableau de bord', view:'overview'}, {label:'Etats Financiers', view:'financials'}],
  'financials-detail': [{label:'Tableau de bord', view:'overview'}, {label:'Etats Financiers', view:'financials'}, {label:'Detail', view:'financials-detail'}],
  ...
  marche: [{label:'Tableau de bord', view:'overview'}, {label:'Marche BRVM', view:'marche'}]
};
...
function nav(id, noHash) {
  ...
  if (id === 'marche' && typeof loadMarche === 'function') {
...
function parseHash() {
  ...
  if (h.startsWith('#fiche=')) {
    ...
    if (typeof openFiche === 'function') {
      ...
      console.warn('openFiche non definie');
    }
    return;
  }
