...
(function () {
  ...
  window.TITLES = {
    ...
    portefeuille:'Portefeuille', 'matieres-premieres':'Matières premières', alertes:'Alertes de Prix', financials:'États Financiers','financials-detail':'Détail Financier', fiche:'Fiche Titre',
  ...
  window.BREADCRUMBS = {
    ...
    'matieres-premieres':[{label:'Tableau de bord',view:'overview'},{label:'Matières premières',view:'matieres-premieres'}],
  ...
  window.renderMap = {
    ...
    obligations:'renderObligations', 'matieres-premieres':'renderMatieresPremieres', documents:'renderDocuments', 'evenements-valeurs':'renderEvenementsValeurs'
  };
