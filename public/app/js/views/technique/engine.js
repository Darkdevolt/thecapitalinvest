...
if (window.__engineLoaded) {
  ...
  window.navDragging = window.navDragging || false;
  window.navResizeL = window.navResizeL || false;
  window.navResizeR = window.navResizeR || false;
  window.navStartX = window.navStartX || 0;
  window.navStartZoom = window.navStartZoom || null;

  var navDragging = window.navDragging;
  var navResizeL = window.navResizeL;
  var navResizeR = window.navResizeR;
  var navStartX = window.navStartX;
  var navStartZoom = window.navStartZoom;
  ...
  window.atHeikinAshi = atHeikinAshi;

  // ── Extraction donnees historique ──
  ...
  window.atShowAggInfo = atShowAggInfo;
  ...
  function atGetSourceDate(bucket, interval) {
    ...
    if (bucket._dates && bucket._dates.length > 0) {
      return bucket._dates[bucket._dates.length - 1];
    }
    return bucket.date;
  }
  window.atGetSourceDate = atGetSourceDate;
  ...
  window.atDrawCanvas = atDrawCanvas;
  ...
  window._atDrawMain = _atDrawMain;
  ...
  window._atDrawMACD = _atDrawMACD;
