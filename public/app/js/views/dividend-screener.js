...
(function () {
  ...
  function injectCss(){
    ...
    s.textContent=`
      ...
      #view-dividend-screener .di-pills{display:flex;gap:7px;flex-wrap:wrap;margin:10px 0}.di-pill{padding:7px 9px;border-radius:8px;border:1px solid rgba(255,255,255,.075);background:rgba(255,255,255,.018);font-size:9px;color:var(--dim)}.di-pill strong{margin-left:4px;color:var(--text);font-size:10px}.di-actions{display:flex;gap:6px}.di-actions button{cursor:pointer;width:30px;height:30px;border:1px solid rgba(255,255,255,.075);border-radius:7px;background:rgba(255,255,255,.025);color:var(--text)}
