...
(function () {
  ...
  function injectCss(){
    ...
    s.textContent=`
      #view-dividend-screener{padding-bottom:40px}
      #view-dividend-screener .page-header{position:relative;overflow:hidden;margin-bottom:20px;padding:26px 28px;border:1px solid var(--border2);border-radius:16px;background:radial-gradient(circle at 88% 15%,rgba(212,175,55,.12),transparent 28%),linear-gradient(135deg,rgba(255,255,255,.045),rgba(255,255,255,.012));box-shadow:0 16px 40px rgba(0,0,0,.16)}
      #view-dividend-screener .page-header h1{margin:0;font-size:30px;letter-spacing:-.035em;font-weight:800}.page-header p{max-width:760px;margin:8px 0 0;color:var(--dim);font-size:12px;line-height:1.65}
      #view-dividend-screener .di-hero{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:10px;margin:0 0 18px}.di-kpi{position:relative;min-height:92px;padding:15px 16px;border:1px solid rgba(255,255,255,.075);border-radius:12px;background:linear-gradient(145deg,rgba(255,255,255,.042),rgba(255,255,255,.012));box-shadow:0 8px 24px rgba(0,0,0,.1);overflow:hidden}.di-kpi:before{content:"";position:absolute;left:0;top:0;width:3px;height:100%;background:var(--gold);opacity:.7}.di-kpi-label{font-size:9px;color:var(--dim);text-transform:uppercase;letter-spacing:.12em;font-weight:700}.di-kpi-value{font-size:23px;line-height:1.1;font-weight:800;margin-top:9px;color:var(--text)}.di-kpi-sub{font-size:9px;color:var(--dim);margin-top:6px}
      #view-dividend-screener .card{border:1px solid rgba(255,255,255,.075);border-radius:14px;overflow:hidden;box-shadow:0 10px 30px rgba(0,0,0,.11)}.card-header{min-height:52px;padding:14px 17px;border-bottom:1px solid rgba(255,255,255,.075);background:linear-gradient(180deg,rgba(255,255,255,.026),rgba(255,255,255,.008));display:flex;align-items:center;justify-content:space-between;gap:14px}.card-body{padding:17px}
      #view-dividend-screener .di-toolbar{display:grid;grid-template-columns:1.4fr 1fr repeat(4,minmax(120px,.8fr));gap:9px;align-items:center}.di-toolbar:before{content:"FILTRER LE MARCHÉ";grid-column:1/-1;font-size:9px;letter-spacing:.13em;color:var(--dim);font-weight:800}.di-toolbar select,.di-toolbar input{width:100%;min-width:0;height:38px;padding:0 11px;border:1px solid rgba(255,255,255,.075);border-radius:8px;background:rgba(0,0,0,.14);color:var(--text);font-size:11px;outline:none}.di-toolbar select:focus,.di-toolbar input:focus{border-color:rgba(212,175,55,.65);box-shadow:0 0 0 3px rgba(212,175,55,.08)}
      /* Sans ceci, la liste déroulante ouverte reprend le fond blanc par défaut du
         navigateur alors que le texte reste clair (couleur héritée du select) :
         texte clair sur fond blanc, illisible. */
      #view-dividend-screener .di-toolbar select option{background:var(--panel-2,#1E1B13);color:var(--text,#F5F0E8)}
      #view-dividend-screener .di-tabs{position:sticky;top:0;z-index:20;display:flex;gap:6px;flex-wrap:wrap;margin:0 0 18px;padding:7px;border:1px solid rgba(255,255,255,.075);border-radius:11px;background:rgba(12,12,12,.88);backdrop-filter:blur(12px);box-shadow:0 8px 24px rgba(0,0,0,.18)}.di-tab{position:relative;background:transparent;color:var(--dim);border:0;padding:9px 14px;border-radius:7px;cursor:pointer;font-size:10px;font-weight:700;transition:.18s}.di-tab:hover{color:var(--text);background:rgba(255,255,255,.04)}.di-tab.active{color:var(--text);background:rgba(212,175,55,.11);box-shadow:inset 0 0 0 1px rgba(212,175,55,.28)}.di-tab.active:after{content:"";position:absolute;left:14px;right:14px;bottom:3px;height:2px;border-radius:2px;background:var(--gold)}
      #view-dividend-screener .di-grid{display:grid;grid-template-columns:1.15fr .85fr;gap:14px;margin-bottom:14px}.di-grid.equal{grid-template-columns:1fr 1fr}.di-chart{height:300px;position:relative}.di-chart.tall{height:360px}.di-card-title{font-weight:750;font-size:12px}.di-card-meta{font-size:9px;color:var(--dim);margin-top:4px;line-height:1.5}
      #view-dividend-screener .di-pills{display:flex;gap:10px;flex-wrap:wrap;margin:10px 0}.di-pill{display:inline-flex;align-items:center;gap:5px;padding:7px 11px;border-radius:8px;border:1px solid rgba(255,255,255,.075);background:rgba(255,255,255,.018);font-size:9px;color:var(--dim);white-space:nowrap}.di-pill strong{color:var(--text);font-size:10.5px}.di-actions{display:flex;gap:6px}.di-actions button{cursor:pointer;width:30px;height:30px;border:1px solid rgba(255,255,255,.075);border-radius:7px;background:rgba(255,255,255,.025);color:var(--text)}
      #view-dividend-screener .di-table-row{cursor:pointer}.di-table-row:hover{background:rgba(212,175,55,.045)}#view-dividend-screener thead th{position:sticky;top:0;z-index:2;background:rgba(18,18,18,.97);font-size:9px;text-transform:uppercase;letter-spacing:.07em;color:var(--dim);white-space:nowrap}#view-dividend-screener tbody td{font-size:11px;border-bottom:1px solid rgba(255,255,255,.045);padding-top:11px;padding-bottom:11px}
      #view-dividend-screener .di-badge{display:inline-flex;align-items:center;justify-content:center;font-size:9px;font-weight:700;padding:4px 8px;border:1px solid rgba(255,255,255,.075);border-radius:999px;background:rgba(255,255,255,.018)}.di-good{color:var(--green)!important;border-color:rgba(74,222,128,.32)!important;background:rgba(74,222,128,.055)!important}.di-warn{color:var(--red)!important;border-color:rgba(248,113,113,.32)!important;background:rgba(248,113,113,.05)!important}.di-mid{color:#f0a72a!important;border-color:rgba(240,167,42,.35)!important;background:rgba(240,167,42,.05)!important}
      #view-dividend-screener .di-calendar{display:grid;grid-template-columns:repeat(7,1fr);gap:7px}.di-day{min-height:82px;padding:9px;border:1px solid rgba(255,255,255,.075);border-radius:9px;background:rgba(255,255,255,.018)}.di-event{margin-top:6px;font-size:9px;color:var(--gold);cursor:pointer;padding:4px 5px;border-radius:5px;background:rgba(212,175,55,.06);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
      #view-dividend-screener .di-calc{display:grid;grid-template-columns:repeat(4,1fr);gap:10px}.di-calc>div{padding:12px;border:1px solid rgba(255,255,255,.075);border-radius:10px;background:rgba(255,255,255,.018)}.di-calc label{display:block;margin-bottom:7px;font-size:9px;color:var(--dim);text-transform:uppercase;letter-spacing:.08em;font-weight:700}.di-calc input{width:100%;height:36px;padding:0 9px;border:1px solid rgba(255,255,255,.075);border-radius:7px;background:rgba(0,0,0,.13);color:var(--text)}.di-calc-result{font-size:18px;font-weight:800;color:var(--gold)}
      @media(max-width:1200px){#view-dividend-screener .di-hero{grid-template-columns:repeat(3,1fr)}#view-dividend-screener .di-toolbar{grid-template-columns:repeat(3,1fr)}}@media(max-width:1000px){#view-dividend-screener .di-grid,#view-dividend-screener .di-grid.equal{grid-template-columns:1fr}}@media(max-width:700px){#view-dividend-screener .di-hero{grid-template-columns:repeat(2,1fr)}#view-dividend-screener .di-toolbar{grid-template-columns:1fr 1fr}#view-dividend-screener .di-tabs{overflow-x:auto;flex-wrap:nowrap}#view-dividend-screener .di-tab{white-space:nowrap}#view-dividend-screener .di-calc{grid-template-columns:1fr 1fr}#view-dividend-screener .di-calendar{grid-template-columns:repeat(2,1fr)}}@media(max-width:430px){#view-dividend-screener .di-toolbar{grid-template-columns:1fr}#view-dividend-screener .di-calc{grid-template-columns:1fr}#view-dividend-screener .di-chart{height:260px}}
    `;
  ...
  function build(){
    ...
    bind();
    // Première ouverture : les données sont en général déjà chargées (on arrive
    // depuis le tableau de bord), donc on dessine tout de suite au lieu
    // d'attendre un tc:dataready qui ne viendra plus.
    try{renderAll();}catch(e){console.error('[DIVIDENDES] rendu initial',e);}
  }
  const calcTouched={};
  let cache={rows:[]};
  ...
  function renderScatter(rows){
    ...
    const sel=document.getElementById('diTicker')?.value||selectedTicker||'';
    const others=pts.filter(p=>p.r.t!==sel), mine=sel?pts.filter(p=>p.r.t===sel):[];
    // Le titre choisi doit sauter aux yeux au milieu du nuage : couleur et
    // taille nettement différentes, dans un second dataset dessiné après
    // le premier pour ne jamais se faire recouvrir par un point voisin.
    const datasets=[{label:'Titres',data:others,backgroundColor:'rgba(212,175,55,.4)',borderColor:'rgba(212,175,55,.55)',borderWidth:1,pointRadius:5,pointHoverRadius:7}];
    if(mine.length)datasets.push({label:'Titre sélectionné',data:mine,backgroundColor:'rgba(96,165,250,.92)',borderColor:'#fff',borderWidth:2,pointRadius:10,pointHoverRadius:12});
    chart('diScatter','scatter',{datasets},{plugins:{tooltip:{callbacks:{label:c=>{const r=c.raw.r;return r.t+' · Yield '+pct(r.y)+' · Growth '+pct(r.g3);}}}},scales:{x:{title:{display:true,text:'Dividend Yield (%)',color:'#9e978e'}},y:{title:{display:true,text:'Dividend Growth 3Y (%)',color:'#9e978e'}}}});
  }
