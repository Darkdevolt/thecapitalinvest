(function(){
  ...
  window.loadIndexHistory=()=>window.loadData('allIndicesHistory',secondary.indicesHistory,{globalName:'allIndicesHistory'}).then(v=>{window.allIndices=Array.isArray(window.allIndicesHistory)&&window.allIndicesHistory.length?window.allIndicesHistory:window.allIndices;return window.allIndicesHistory;});
