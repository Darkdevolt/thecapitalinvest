...
(function () {
    ...
    load('admin/js/dashboard/dashboard-overview.js?v=20260814-unified', 'dashboard-overview');
    load('admin/js/cours/cours-historique.js?v=20260814-unified', 'cours-historique');
    load('admin/js/cours/admin-cours-historique-unified.js?v=20260821-unified', 'admin-cours-historique-unified');
    load('admin/js/seances/seances-integrity-hardening.js?v=20260821-integrity', 'seances-integrity-hardening');
})();
