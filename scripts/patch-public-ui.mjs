...
// Presentation-only build patch. It reads complete source files and writes only
// presentation/navigation changes into the Vercel build output. It never touches
// API/backend files or portfolio business-logic files.
...
const marker = '/* THE CAPITAL — FINAL SECONDARY MOBILE NAV */';
